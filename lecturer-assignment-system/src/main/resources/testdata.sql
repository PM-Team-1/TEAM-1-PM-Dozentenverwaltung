...
INSERT INTO lecturer (id, title, first_name, last_name, second_name, email, phone, is_extern, preference) VALUES
  ...
  (2, 'NO_TITLE', 'Bernd', 'Schmidt', 'Karl', 'bernd.schmidt@uni.de', '+491721234568', 0, 'PREFER_MASTER'),
  (3, 'NO_TITLE', 'Carla', 'Meier', 'Theresa', 'carla.meier@uni.de', '+491731234569', 0, 'PREFER_MASTER'),
  (4, 'DOCTOR', 'Dieter', 'Fischer', NULL, 'd.fischer@provadis.de', '+491741234570', 1, 'PREFER_MASTER'),
  (5, 'NO_TITLE', 'Eva', 'Klein', NULL, 'eva.klein@other.edu', '+491751234571', 1, 'PREFER_MASTER'),
  (6, 'NO_TITLE', 'Frank', 'Wagner', NULL, 'frank.wagner@uni.de', '+491761234572', 0, 'PREFER_MASTER'),

  (7, 'NO_TITLE', 'Gerd', 'Hartmann', 'Heinrich', 'gerd.hartmann@uni.de', '+491771234573', 0, 'PREFER_BACHELOR'),
  (8, 'PROFESSOR', 'Heike', 'Becker', NULL, 'heike.becker@uni.de', '+491781234574', 1, 'PREFER_BACHELOR'),
  (9, 'NO_TITLE', 'Ines', 'Schreiber', NULL, 'ines.schreiber@uni.de', '+491791234575', 0, 'PREFER_BACHELOR'),
  (10, 'NO_TITLE', 'Jan', 'Keller', NULL, 'jan.keller@uni.de', '+491701234576', 0, 'PREFER_BACHELOR'),
  (11, 'NO_TITLE', 'Katrin', 'Lorenz', NULL, 'k.lorenz@other.edu', '+491721234577', 1, 'PREFER_BACHELOR'),
  (12, 'NO_TITLE', 'Lukas', 'Neumann', NULL, 'l.neumann@uni.de', '+491731234578', 0, 'PREFER_BACHELOR'),

  (13, 'NO_TITLE', 'Maja', 'Koch', NULL, 'maja.koch@hs.de', '+491741234579', 0, 'ONLY_MASTER'),
  (14, 'DOCTOR', 'Nils', 'Peters', NULL, 'n.peters@provadis.de', '+491751234580', 1, 'ONLY_MASTER'),
  (15, 'NO_TITLE', 'Olga', 'Brandt', NULL, 'olga.brandt@uni.de', '+491761234581', 0, 'ONLY_MASTER'),
  ...
  (25, 'NO_TITLE', 'Yann', 'Zimmer', 'Paul', 'yann.zimmer@uni.de', '+491761234591', 0, 'ALLES'),
