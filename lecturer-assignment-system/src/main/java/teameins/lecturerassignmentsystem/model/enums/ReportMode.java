...
public enum ReportMode {
    ALL_COURSES_IN_PROVADIS(
            ...
            ReportService::getReportHeldAtProvadis),
    ALL_COURSES_NOT_IN_PROVADIS(
            ...
            ReportService::getReportNotYetHeldAtProvadis),
    ALL_COURSES_WITH_NO_LECTURERS(
            ...
            ReportService::getReportCoursesWithoutLecturer),
    ALL_COURSES_WITH_ONLY_LECTURERS_NOT_HELD_IN_PROVADIS(
            ...
            ReportService::getReportCoursesOnlyHeldElsewhere);

    private final String header;
    private final String filename;
    private final String description;
    private final Function<ReportService, List<?>> reportValueSupplier;
}
